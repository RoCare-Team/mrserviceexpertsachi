...
//   { id: "ro-service", name: "RO Service", image: RoService },
  { id: "ac", name: "Air Conditioner", image: RoRepair},
  {id:"washing-machine",name:"Washing Machine",image:RoRepair},
  { id: "water-purifier", name: "Water Purifier", image: RoInstallation },
  { id: "gyeser", name: "Gyeser", image: RoInstallation },
  { id: "refrigerator", name: 'Refrigerator', image: AMC },
//   { id: "led", name: "Led", image: RoService },
{ id: "microwav-repair", name: "Microwave", image: RoService},
  {id:"vaccum-cleaner",name:"Vaccum Cleaner",image: AMC}
